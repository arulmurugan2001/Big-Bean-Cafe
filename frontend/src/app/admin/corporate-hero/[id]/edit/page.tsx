...
export default function EditCorporateHero() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await apiRequest(`/corporate-hero/${id}`, { method: 'PUT', body: fd })
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="flex items-center gap-3 mb-8">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Edit Corporate Hero Banner</h1>
      </div>
