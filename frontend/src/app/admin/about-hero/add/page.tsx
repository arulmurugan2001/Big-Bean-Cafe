...
export default function AddAboutHero() {
  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Add Hero Banner</h1>
          <p className="text-gray-500 text-sm mt-1">Create a new About page hero banner</p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
              ...
              <input className={inputClass} value={form.button_primary_text} onChange={e => set('button_primary_text', e.target.value)} placeholder="Know Our Story" />
            </div>
            <div>
              <label className={labelClass}>Primary Button URL</label>
              <input className={inputClass} value={form.button_primary_url} onChange={e => set('button_primary_url', e.target.value)} placeholder="#story" />
            </div>
            <div>
              <label className={labelClass}>Secondary Button Text</label>
              <input className={inputClass} value={form.button_secondary_text} onChange={e => set('button_secondary_text', e.target.value)} placeholder="Explore Outlets" />
            </div>
            <div>
              <label className={labelClass}>Secondary Button URL</label>
              <input className={inputClass} value={form.button_secondary_url} onChange={e => set('button_secondary_url', e.target.value)} placeholder="/outlets" />
            </div>
          </div>
        </div>
