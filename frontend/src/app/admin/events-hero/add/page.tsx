...
export default function AddEventsHero() {
  ...
  const [form, setForm] = useState({
    ...
    title: 'Big Bean Cafe Events',
    subtitle: 'Workshops, live nights, community meetups and café experiences.',
  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Add Events Hero</h1>
          <p className="text-gray-500 text-sm mt-1">Create the Events page hero banner</p>
        </div>
      </div>
